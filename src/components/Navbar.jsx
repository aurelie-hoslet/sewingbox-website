    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-rose-light/50 shadow-sm">
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="https://github.com/aurelie-hoslet/patrontheque/releases/download/v1.3.0/Sewing.Box.Setup.1.3.0.exe"
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-rose-light/50 px-6 py-4 flex flex-col gap-4">
          ...
          <a href="https://github.com/aurelie-hoslet/patrontheque/releases/download/v1.3.0/Sewing.Box.Setup.1.3.0.exe" onClick={() => setOpen(false)}
